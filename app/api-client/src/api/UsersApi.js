...
export default class UsersApi {
  ...
  apiUsersFollowingGetWithHttpInfo(userId) {
    ...
    if (userId === undefined || userId === null) {
      throw new Error(
        "Missing the required parameter 'userId' when calling apiUsersFollowingGet"
      );
    }
  ...
  apiUsersFollowingGet(userId) {
    return this.apiUsersFollowingGetWithHttpInfo(userId).then(
  ...
  apiUsersMeAvatarPostWithHttpInfo(avatar) {
    ...
    if (avatar === undefined || avatar === null) {
      throw new Error(
        "Missing the required parameter 'avatar' when calling apiUsersMeAvatarPost"
      );
    }
  ...
  apiUsersMeAvatarPost(avatar) {
    return this.apiUsersMeAvatarPostWithHttpInfo(avatar).then(
      function (response_and_data) {
        return response_and_data.data;
      }
    );
   ...
   */
  apiUsersMeGet() {
    return this.apiUsersMeGetWithHttpInfo().then(function (response_and_data) {
      return response_and_data.data;
    });
  }
  ...
  apiUsersRecipesGet(opts) {
    return this.apiUsersRecipesGetWithHttpInfo(opts).then(
      function (response_and_data) {
        return response_and_data.data;
      }
    );
  ...
  apiUsersUserIdFollowersDeleteWithHttpInfo(userId) {
    ...
    if (userId === undefined || userId === null) {
      throw new Error(
        "Missing the required parameter 'userId' when calling apiUsersUserIdFollowersDelete"
      );
    }
  ...
  apiUsersUserIdFollowersDelete(userId) {
    return this.apiUsersUserIdFollowersDeleteWithHttpInfo(userId).then(
      function (response_and_data) {
        return response_and_data.data;
      }
    );
  ...
  apiUsersUserIdFollowersGetWithHttpInfo(userId) {
    ...
    if (userId === undefined || userId === null) {
      throw new Error(
        "Missing the required parameter 'userId' when calling apiUsersUserIdFollowersGet"
      );
    }
  ...
  apiUsersUserIdFollowersGet(userId) {
    return this.apiUsersUserIdFollowersGetWithHttpInfo(userId).then(
      function (response_and_data) {
        return response_and_data.data;
      }
    );
  ...
  apiUsersUserIdFollowersPostWithHttpInfo(userId) {
    ...
    if (userId === undefined || userId === null) {
      throw new Error(
        "Missing the required parameter 'userId' when calling apiUsersUserIdFollowersPost"
      );
    }
  ...
  apiUsersUserIdFollowersPost(userId) {
    return this.apiUsersUserIdFollowersPostWithHttpInfo(userId).then(
      function (response_and_data) {
        return response_and_data.data;
      }
    );
  ...
  apiUsersUserIdGetWithHttpInfo(userId) {
    ...
    if (userId === undefined || userId === null) {
      throw new Error(
        "Missing the required parameter 'userId' when calling apiUsersUserIdGet"
      );
    }
  ...
  apiUsersUserIdGet(userId) {
    return this.apiUsersUserIdGetWithHttpInfo(userId).then(
      function (response_and_data) {
        return response_and_data.data;
      }
    );
  ...
  apiUsersUserIdRecipesGetWithHttpInfo(userId, opts) {
    ...
    if (userId === undefined || userId === null) {
      throw new Error(
        "Missing the required parameter 'userId' when calling apiUsersUserIdRecipesGet"
      );
    }
  ...
  apiUsersUserIdRecipesGet(userId, opts) {
    return this.apiUsersUserIdRecipesGetWithHttpInfo(userId, opts).then(
      function (response_and_data) {
        return response_and_data.data;
      }
    );
